...
Contents are the canvas for each feature. You can create a `ContentBlank`, which is an empty canvas, and add components to it manually. In most cases this is not necessary because Goowee provides ready-to-use content classes.
